MySQL JDBC Driver not required!
===============================

A special thanks to the folks at MariaDB for making their MySQL compatible JDBC driver available and
under LGPL license.

This allows us to distribute their .jar instead of forcing decaf users to download the driver from Oracle's
WWW site and agreeing to their GPL licence terms.
