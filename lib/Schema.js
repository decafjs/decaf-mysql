...
(function() {
    ...
    var Schema = function () {
        ...
        //new Thread(function() {
        //    Thread.sleep(1);
            // added this on a separated thread so that it has time for the DB to get initialized
            ...
            var version = SQL.getScalar('SELECT `value` from SchemaSettings WHERE `key`=' + SQL.quote('version'));
            if (!version) {
                version = 'v1';
