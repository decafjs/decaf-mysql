...
decaf.extend(MySQL.prototype, {
    ...
    releaseConnection : function () {
        ...
        if (me.SQL) {
            ...
            //if (me.transactionPending) {
            //    try {
            //        console.log('WARNING: connection released while transaction in progress');
            //        me.SQL.rollback();
            //        releaseConnection(me.SQL);
            //    }
            //    catch (e) {
    ...
    /**
     * Store a record represented by an object into the specified table.
     *
     * Generates a query like:
     *     REPLACE INTO table (key, key, key...) VALUES (value, value, value...)
     *
     * @param table
     * @param o
     * @returns {*}
